function calcola() {
  ...
  var div = primoNumero / secondoNumero;
  alert("La somma è uguale a " + somma);
  alert("La sottrazione è uguale a " + sottr);
  alert("La moltiplicazione è uguale a " + molt);
  alert("La divisione è uguale a " + div);
}
